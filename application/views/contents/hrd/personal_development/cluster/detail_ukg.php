      ...
      <div class="modal-body">
          ...
          <div class="form-group col-md-10 text-center">
            <div class="row">
              <div class="col-md-3 text-center">
                <label>Level 1</label>
                <div id="ukg_approver_lv1"></div>
              </div>
              <div class="col-md-3 text-center">
                <label>Level 2</label>
                <div id="ukg_approver_lv2"></div>
              </div>
              <div class="col-md-3 text-center">
                <label>Level 3</label>
                <div id="ukg_approver_lv3"></div>
              </div>
              <div class="col-md-3 text-center">
                <label>Level 4</label>
                <div id="ukg_approver_lv4"></div>
              </div>
            </div> 
        ...
        <div class="modal-footer">
          <div class="float-right">
            <button type="submit" class="btn btn-primary" id="btn_resubmit_ukg" hidden>Ajukan Ulang</button>
