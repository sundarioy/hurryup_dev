          ...
          <li class="nav-item has-treeview <?php if ($this->uri->segment(2) == 'report') { echo 'menu-open'; } ?>">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?php echo base_url() ?>hrd/personaldevelopment" class="nav-link <?php if ($this->uri->segment(3) == 'employee') { echo 'active'; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Daftar Pegawai</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>hrd/personaldevelopment/cluster" class="nav-link <?php if ($this->uri->segment(3) == 'presence') { echo 'active'; } ?>">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Kenaikan Golongan</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url() ?>admin/report/overtime" class="nav-link <?php if ($this->uri->segment(3) == 'overtime') { echo 'active'; } ?>">
                  <i class="far fa-circle nav-icon"></i>
