          ...
          <tbody>
            <?php $no = 1; foreach ($users->result() as $data) {?>
              <tr>
                ...
                <td class="center">
                  <a href="<?php echo base_url() ?>employee/personaldevelopment/show/<?php echo $data->employee_id ?>" title="detail" class="btn btn-info btn-xs"><i class="fa fa-search" aria-hidden="true"></i></a>
                </td>
              </tr>
            <?php } ?>
          </tbody>
